                    ...
                    <div class="col-xxl-5">
                        ...
                        <div class="text-center text-xxl-start">
                            ...
                            @else
                                ...
                                <div
                                    class="d-grid gap-3 d-sm-flex justify-content-sm-center justify-content-xxl-start mb-3">
                                    <a class="btn btn-primary btn-lg px-5 py-3 fs-6 fw-bolder" href="">Profile</a>
                                    <a class="btn btn-outline-dark btn-lg px-5 py-3 fs-6 fw-bolder"
                                        href="">Contact</a>
                                </div>
                            @endif
                        ...
                        @if (!is_null($content))
                            <div class="text-center my-5">
                                ...
                                <div class="d-flex justify-content-center fs-2 gap-4">
                                    <a class="text-gradient" href="https://www.instagram.com/dianmitasari059?igsh=MWRiZTN5bTQzdXg1YQ=="><i class="bi bi-instagram"></i></a>
                                    <a class="text-gradient" href="https://www.facebook.com/share/EprxA6o2gxt1CLLa/?mibextid=qi2Omg=="><i class="bi bi-facebook"></i></a>
                        ...
                        @else
                            <div class="text-center my-5">
                                ...
                                <div class="d-flex justify-content-center fs-2 gap-4">
                                    <a class="text-gradient" href="https://www.instagram.com/dianmitasari059?igsh=MWRiZTN5bTQzdXg1YQ=="><i class="bi bi-instagram"></i></a>
                                    <a class="text-gradient" href="https://www.facebook.com/share/EprxA6o2gxt1CLLa/?mibextid=qi2Omg"><i class="bi bi-facebook"></i></a>
                                    <a class="text-gradient" href="https://www.tiktok.com/@mitasari059_?_t=8o0vKWTRWL6&_r=1"><i class="bi bi-TikTok"></i></a>
                                </div>
                            </div>
                        @endif
                    </div>
    ...
    <footer class="bg-white py-4 mt-auto">
        <div class="container px-5">
            <div class="row align-items-center justify-content-between flex-column flex-sm-row">
                <div class="col-auto">
                <span>Copyright &copy; <a href="https://www.instagram.com/dianmitasari059?igsh=MWRiZTN5bTQzdXg1YQ==" target="_blank">Instagram</a>
                </div>
                <div class="col-auto">
                    <a class="small" href="https://www.nytimes.com/2021/09/16/technology/digital-privacy.html">Privacy</a>
                    <span class="mx-1">&middot;</span>
                    <a class="small" href="https://dictionary.cambridge.org/dictionary/english/terms">Terms</a>
                    <span class="mx-1">&middot;</span>
                    <a class="small" href="https://contacts.google.com/">Contact</a>
                </div>
            </div>
        </div>
    </footer>
